...
G4VPhysicalVolume* PMDetectorConstruction::Construct()
{
    ...
    // Define Fluorine-18
    G4Isotope *F18 = new G4Isotope("F18", 8, 18, 18.000938 * g / mole);
    G4Element *elF18 = new G4Element("Fluroine-18", "F18", 1);
    ...
    G4VisAttributes* worldVisAttr = new G4VisAttributes(G4Colour(0., 0., 0.)); // black
    worldVisAttr->SetVisibility(true);
    worldVisAttr->SetForceWireframe(true); // wireframe so you can see inside
    ...
    G4VisAttributes *detVisAtt = new G4VisAttributes(G4Colour(0.0, 1.0, 1.0, 0.5));
